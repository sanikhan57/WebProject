...
namespace Car_Showroom.Controllers
{
    ...
    {
        private Car_ShowroomEntities db = new Car_ShowroomEntities();
        ...
        public ActionResult Create([Bind(Include = "id,Prod_Name,Cat_id,Brand_id,Qty,Price")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Prod_Name,Cat_id,Brand_id,Qty,Price")] Product product)
        {
            if (ModelState.IsValid)
            {
